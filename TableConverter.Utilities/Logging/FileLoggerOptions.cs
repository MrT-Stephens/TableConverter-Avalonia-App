...
public class FileLoggerOptions
{
	...
	public enum FileRollingConvention
	{
		...
		/// <summary>
		/// New files will get an ascending rolling index, but the latest file is always the file without an index. More performant alt for descending rolling. 0-1-2-3-1-2-3
		/// </summary>
		AscendingStableBase,
