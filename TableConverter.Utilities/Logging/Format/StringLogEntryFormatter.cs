...
public class StringLogEntryFormatter
{
	...
	/// </summary>
	public string StringBuilderLogEntryFormat(string logName, DateTime timeStamp, LogLevel logLevel, EventId eventId,
	...
	public string StringBuilderLogEntryFormat(LogMessage logMsg, DateTime timeStamp)
		=> StringBuilderLogEntryFormat(logMsg.LogName, timeStamp, logMsg.LogLevel, logMsg.EventId, logMsg.Message,
			logMsg.Exception);
	...
	/// </summary>
	public string LowAllocLogEntryFormat(string? logName, DateTime timeStamp, LogLevel logLevel, EventId eventId,
		string message, Exception? exception)
	{
	...
	public string LowAllocLogEntryFormat(LogMessage logMsg, DateTime timeStamp)
		=> LowAllocLogEntryFormat(logMsg.LogName, timeStamp, logMsg.LogLevel, logMsg.EventId, logMsg.Message,
			logMsg.Exception);
