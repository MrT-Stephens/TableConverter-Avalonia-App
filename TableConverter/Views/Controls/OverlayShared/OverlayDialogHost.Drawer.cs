...
public partial class OverlayDialogHost
{
    ...
    internal async void AddModalDrawer(DrawerControlBase control)
    {
        ...
        var element = control.GetVisualDescendants().OfType<InputElement>().FirstOrDefault(FocusHelper.GetDialogFocusHint);
    ...
    private async void OnDrawerControlClosing(object? sender, OverlayResultEventArgs e)
    {
