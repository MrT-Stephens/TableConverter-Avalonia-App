...
public class DialogWindow : Window
{
    ...
    public static readonly StyledProperty<bool> IsManagedResizerVisibleProperty = AvaloniaProperty.Register<DialogWindow, bool>(nameof(IsManagedResizerVisible));
    ...
    static DialogWindow()
    {
        DataContextProperty.Changed.AddClassHandler<DialogWindow, object?>((window, e) => window.OnDataContextChange(e));
    }
    ...
    {
        if (CanDragMove) BeginMoveDrag(e);
    }
}
