...
public class DefaultDrawerControl : DrawerControlBase
{
    ...
    public static readonly StyledProperty<DialogButton> ButtonsProperty =
        AvaloniaProperty.Register<DefaultDrawerControl, DialogButton>(nameof(Buttons), DialogButton.OkCancel);

    public static readonly StyledProperty<DialogMode> ModeProperty =
        AvaloniaProperty.Register<DefaultDrawerControl, DialogMode>(nameof(Mode), DialogMode.None);

    public static readonly StyledProperty<string?> TitleProperty =
        AvaloniaProperty.Register<DefaultDrawerControl, string?>(nameof(Title));
    ...
    public override void Close()
    {
        ...
        else
        {
            ...
            RaiseEvent(new OverlayResultEventArgs(ClosedEvent, result));
        }
    }
