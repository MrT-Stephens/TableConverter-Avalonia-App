...
/// </summary>
/// <remarks>
/// Unlike other <see cref="SpreadsheetPanel"/> implementations, the <see cref="SpreadsheetCanvas"/> doesn't lay out
/// its children in any particular layout. Instead, the positioning of each child control is
/// defined by the <code>SpreadsheetCanvas.Left</code>, <code>SpreadsheetCanvas.Top</code>, <code>SpreadsheetCanvas.Right</code>
/// and <code>SpreadsheetCanvas.Bottom</code> attached properties.
/// </remarks>
public class SpreadsheetCanvas : SpreadsheetPanel, INavigableContainer
{
    /// <summary>
    /// Defines the Left attached property.
    /// </summary>
    public static readonly AttachedProperty<double> LeftProperty =
        AvaloniaProperty.RegisterAttached<SpreadsheetCanvas, Control, double>("Left", double.NaN);

    /// <summary>
    /// Defines the Top attached property.
    /// </summary>
    public static readonly AttachedProperty<double> TopProperty =
        AvaloniaProperty.RegisterAttached<SpreadsheetCanvas, Control, double>("Top", double.NaN);

    /// <summary>
    /// Defines the Right attached property.
    /// </summary>
    public static readonly AttachedProperty<double> RightProperty =
        AvaloniaProperty.RegisterAttached<SpreadsheetCanvas, Control, double>("Right", double.NaN);

    /// <summary>
    /// Defines the Bottom attached property.
    /// </summary>
    public static readonly AttachedProperty<double> BottomProperty =
        AvaloniaProperty.RegisterAttached<SpreadsheetCanvas, Control, double>("Bottom", double.NaN);

    /// <summary>
    /// Initializes static members of the <see cref="SpreadsheetCanvas"/> class.
    /// </summary>
    static SpreadsheetCanvas()
    {
        ClipToBoundsProperty.OverrideDefaultValue<SpreadsheetCanvas>(false);
        AffectsParentArrange<SpreadsheetCanvas>(LeftProperty, TopProperty, RightProperty, BottomProperty);
    }
    ...
    /// <param name="finalSize">The size allocated to the SpreadsheetCanvas.</param>
