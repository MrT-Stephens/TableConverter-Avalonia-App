...
[DataGenerationModule("Person", "Module for generating personal information such as names, gender, biography, etc.")]
    ...
    : PersonModule(faker, locale, randomizer)
{
    ...
    public override string FirstName(SexEnum sex)
    {
    ...
    public override string MiddleName(SexEnum sex)
    {
    ...
    public override string LastName(SexEnum sex)
    {
    ...
    public override string Title(SexEnum sex)
    {
    ...
    public override string Sex(SexFormat format)
    {
    ...
    public override string Suffix(SexEnum sex)
    {
