...
{
    public class ConverterHandlerService
    {
        public Task<List<ConverterType>> GetConverterTypesAsync()
        {
            return Task.FromResult(new List<ConverterType>()
            {
                new ConverterType("CSV", ".csv",
                        ...
                        true, true, new ConverterHandler_CSV()),
                new ConverterType("SQL", ".sql",
                        ...
                        true, true, new ConverterHandler_SQL()),
                new ConverterType("Ascii", ".txt",
                        ...
                        false, true, new ConverterHandler_Ascii()),
                new ConverterType("Markdown", ".md",
                        ...
                        true, true, new ConverterHandler_Markdown()),
                new ConverterType("XML", ".xml",
                        ...
                        true, true, new ConverterHandler_XML()),
                new ConverterType("HTML", ".html",
                        ...
                        true, true, new ConverterHandler_HTML()),
                new ConverterType("LaTeX", ".tex",
                        ...
                        false, true, new ConverterHandler_LaTex()),
                ...
                new ConverterType("Excel", ".xlsx",
                        ...
                        true, true, new ConverterHandler_Excel()),
                ...
                new ConverterType("ASP", ".asp",
                        ...
                        true, true, new ConverterHandler_ASP()),
                new ConverterType("Multi-Line", ".txt",
                        ...
                        false, true, new ConverterHandler_MultiLine()),
                new ConverterType("PDF", ".pdf",
                        ...
                        false, true, new ConverterHandler_PDF()),
                new ConverterType("YAML", ".yaml",
                        ...
                        true, true, new ConverterHandler_YAML())
            });
        }
    }
}
