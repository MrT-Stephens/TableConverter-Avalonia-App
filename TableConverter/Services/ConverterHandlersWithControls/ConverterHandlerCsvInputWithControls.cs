...
public class ConverterHandlerCsvInputWithControls : ConverterHandlerCsvInput, IInitializeControls
{
    ...
    public void InitializeControls()
    {
        ...
        {
            if (sender is ToggleSwitch check_box) Options!.Header = check_box.IsChecked ?? false;
        };
