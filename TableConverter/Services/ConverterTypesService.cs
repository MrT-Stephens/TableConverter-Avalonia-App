...
namespace TableConverter.Services
{
    public class ConverterTypesService
    {
        ...
        [
                ...
                new ConverterType("Ascii Tables", 
                        [ ".txt" ], 
                        [ "text/plain" ], 
                        [ "public.plain-text" ],
