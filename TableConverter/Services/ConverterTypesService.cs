...
namespace TableConverter.Services
{
    ...
    {
        public readonly IEnumerable<ConverterType> Types = new List<ConverterType>()
        {
            new ConverterType("CSV", [ ".csv", ".txt" ], [ "text/csv" ],
                    ...
                    typeof(ConverterHandlerCsvInputWithControls), typeof(ConverterHandlerCsvOutputWithControls)),
            new ConverterType("SQL", [ ".sql", ".txt" ], [ "text/plain" ],
                    ...
                    typeof(ConverterHandlerSQLInput), typeof(ConverterHandlerSQLOutput)),
            new ConverterType("Ascii Tables", [ ".txt" ], [ "text/plain" ],
                    ...
                    null, typeof(ConverterHandlerAsciiOutputWithControls)),
            new ConverterType("Markdown", [ ".md" ], [ "text/markdown" ],
                    ...
                    null, typeof(ConverterHandlerMarkdownOutput)),
            new ConverterType("XML", [ ".xml" ], [ "text/xml" ],
                    ...
                    typeof(ConverterHandlerXmlInput), typeof(ConverterHandlerXmlOutput)),
            new ConverterType("HTML", [ ".html" ], [ "text/html" ],
                    ...
                    typeof(ConverterHandlerHtmlInput), typeof(ConverterHandlerHtmlOutputWithControls)),
            new ConverterType("LaTeX", [ ".tex" ], [ "application/x-tex" ],
                    ...
                    null, typeof(ConverterHandlerLaTexOutputWithControls)),
            new ConverterType("JSON", [ ".json" ], [ "application/json" ],
                    ...
                    typeof(ConverterHandlerJsonInputWithControls), typeof(ConverterHandlerJsonOutputWithControls)),
            new ConverterType("JSONLines", [ ".jsonl" ], [ "application/x-jsonlines" ],
                    "JSON Lines is a convenient format for storing structured data that may be processed one record at a time. It works well with unix-style text processing tools and shell pipelines. It's a great format for log files. It's also a flexible format for passing messages between cooperating processes.",
                    typeof(ConverterHandlerJsonLinesInput), typeof(ConverterHandlerJsonLinesOutputWithControls)),
            new ConverterType("Excel", [ ".xlsx" ], [ "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" ],
                    ...
                    typeof(ConverterHandlerExcelInput), typeof(ConverterHandlerExcelOutputWithControls)),
            new ConverterType("Word", [ ".docx" ], [ "application/vnd.openxmlformats-officedocument.wordprocessingml.document" ],
                    ...
                    typeof(ConverterHandlerWordInput), typeof(ConverterHandlerWordOutput)),
            new ConverterType("PHP", [ ".php" ], [ "application/x-httpd-php" ],
                    "PHP (recursive acronym for PHP Hypertext Preprocessor ) is a widely-used open source general-purpose scripting language that is especially suited for web development and can be embedded into HTML.",
                    typeof(ConverterHandlerPhpInput), typeof(ConverterHandlerPhpOutput)),
            new ConverterType("Ruby", [ ".rb" ], [ "text/plain" ],
                    "Ruby is a dynamic, open source programming language with a focus on simplicity and productivity. It has an elegant syntax that is natural to read and easy to write.",
                    typeof(ConverterHandlerRubyInput), typeof(ConverterHandlerRubyOutput)),
            new ConverterType("ASP", [ ".asp" ], [ "application/x-asp" ],
                    ...
                    typeof(ConverterHandlerAspInput), typeof(ConverterHandlerAspOutput)),
            new ConverterType("Multi-Line", [ ".txt" ], [ "text/plain" ],
                    ...
                    typeof(ConverterHandlerMultiLineInput), typeof(ConverterHandlerMultiLineOutput)),
            new ConverterType("PDF", [ ".pdf" ], [ "application/pdf" ],
                    ...
                    null, typeof(ConverterHandlerPdfOutput)),
            new ConverterType("YAML", [ ".yaml" ], [ "application/x-yaml" ],
                    ...
                    typeof(ConverterHandlerYamlInput), typeof(ConverterHandlerYamlOutput)),
        };
