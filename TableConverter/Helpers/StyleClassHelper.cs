...
public class StyleClassHelper
{
    public static readonly AttachedProperty<string> ClassesProperty =
        AvaloniaProperty.RegisterAttached<StyleClassHelper, StyledElement, string>("Classes");

    public static readonly AttachedProperty<StyledElement> ClassSourceProperty =
        AvaloniaProperty.RegisterAttached<StyleClassHelper, StyledElement, StyledElement>("ClassSource");

    static StyleClassHelper()
    {
