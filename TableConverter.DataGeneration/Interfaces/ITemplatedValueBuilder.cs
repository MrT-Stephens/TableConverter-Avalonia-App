...
public interface ITemplatedValueBuilder<TFaker, TDataset>
{
    ...
    /// <returns>The builder instance for method chaining.</returns>
    ITemplatedValueBuilder<TFaker, TDataset> AddPlaceholder(string key, Func<TFaker, TDataset, Randomizer, string> resolver);
    ...
    /// <returns>The builder instance for method chaining.</returns>
    ITemplatedValueBuilder<TFaker, TDataset> AddRandomPlaceholder(string key, Func<TDataset, IReadOnlyList<string>> listResolver);
