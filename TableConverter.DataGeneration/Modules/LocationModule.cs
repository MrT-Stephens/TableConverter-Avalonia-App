...
public class LocationModule(FakerBase faker, LocaleBase locale, Randomizer randomizer) : ModuleBase(faker, locale, randomizer)
{
    ...
    {
        return Randomizer.ReplaceSymbolsWithNumbers(Randomizer.GetWeightedValue(Locale.Location.Value.BuildingNumberPattern));
    }
    ...
    {
        return Randomizer.ReplaceSymbolsWithNumbers(Randomizer.GetWeightedValue(Locale.Location.Value.SecondaryAddressPattern));
    }
